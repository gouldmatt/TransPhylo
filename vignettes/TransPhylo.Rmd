...
This simulation contains both the transmission tree between infected hosts and the within-host phylogenetic tree of each host. This can be visualized as a colored phlogenetic tree, where each host is represented by a unique color:
